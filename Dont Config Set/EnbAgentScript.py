...
def foFileTypevalue():
        ...
        foFileTypeoid = scriptinterface.getSnmpOidForNodeName('foFileType')
...
def from_fileTransDest_get_enodebid():
    ...
    fileTransDestoid = scriptinterface.getSnmpOidForNodeName('fileTransDest')
...
def write_staticDate():
    ...
    enodebidiod = scriptinterface.getSnmpOidForNodeName('nodeBSysFunctionId')
    reenodebidiod = enodebidiod+'.0'+'</i><r>'
    nodeBGlobalIdoid = scriptinterface.getSnmpOidForNodeName('nodeBGlobalId')
    renodeBGlobalIdoid = nodeBGlobalIdoid+'.0'+'</i><r>'
    nodeBSysOMAddroid = scriptinterface.getSnmpOidForNodeName('nodeBSysOMAddr')
...
def from_NodeName_get_enodebid():
    nodeBSysFunctionIdoid = scriptinterface.getSnmpOidForNodeName('nodeBSysFunctionId')
...
def fileTransTrap_objectid():
    ...
    fileTransTrapNEIDoid = scriptinterface.getSnmpOidForNodeName('fileTransTrapNEID')
    fileTransTrapTaskIDoid = scriptinterface.getSnmpOidForNodeName('fileTransTrapTaskID')
    fileTransTrapTypeoid = scriptinterface.getSnmpOidForNodeName('fileTransTrapType')
    fileTransTrapNameoid = scriptinterface.getSnmpOidForNodeName('fileTransTrapName')
    fileTransTrapFlagoid = scriptinterface.getSnmpOidForNodeName('fileTransTrapFlag')
    fileTransTrapResultoid = scriptinterface.getSnmpOidForNodeName('fileTransTrapResult')
    fileTransTrapBytesoid = scriptinterface.getSnmpOidForNodeName('fileTransTrapBytes')
    fileTransTrapTimeoid = scriptinterface.getSnmpOidForNodeName('fileTransTrapTime')
...
def get_fileTransType_vlue():
    ...
    fileTransTypeoid = scriptinterface.getSnmpOidForNodeName("fileTransType")
    if currentOid.find(fileTransTypeoid, 0, len(currentOid)) == -1:
            return "null"
    else:
            return scriptinterface.getCurrentValue()
...
def get_fileTransFileName_vlue():
    fileTransFileNameoid = scriptinterface.getSnmpOidForNodeName('fileTransFileName')
...
def get_fileTransFlag_vlue():
    fileTransFlagoid = scriptinterface.getSnmpOidForNodeName('fileTransFlag')
...
def eventGeneralEvent_objectid():
        eventGeneralEventNodeBSysFunctionIdoid=scriptinterface.getSnmpOidForNodeName('eventGeneralEventNodeBSysFunctionId')
        eventGeneralEventTypeoid=scriptinterface.getSnmpOidForNodeName('eventGeneralEventType')
        eventGeneralEventResultoid=scriptinterface.getSnmpOidForNodeName('eventGeneralEventResult')
        eventGeneralEventSourceoid=scriptinterface.getSnmpOidForNodeName('eventGeneralEventSource')
        eventGeneralEventAdditionInfooid=scriptinterface.getSnmpOidForNodeName('eventGeneralEventAdditionInfo')
        eventGeneralEventOccurTimeoid=scriptinterface.getSnmpOidForNodeName('eventGeneralEventOccurTime')
...
def configChgTrap_objectid():
        configChgTrapNeTypeoid=scriptinterface.getSnmpOidForNodeName('configChgTrapNeType')
        configChgTrapNEIDoid=scriptinterface.getSnmpOidForNodeName('configChgTrapNEID')
        configChgTrapTimeoid=scriptinterface.getSnmpOidForNodeName('configChgTrapTime')
        configChgTrapValue1oid=scriptinterface.getSnmpOidForNodeName('configChgTrapValue1')
...
def enodebidiod():
    enodebidoid=scriptinterface.getSnmpOidForNodeName('nodeBSysFunctionId')
...
def isHeartBeat():
        currentOid = scriptinterface.getCurrentOID()
        hbOid = scriptinterface.getSnmpOidForNodeName("nodeBSysOmcrActive")
...
def main():       
    ...
    without = ".1.3.6.1.4.1.5105.80.1.2.2.1.2 .1.3.6.1.4.1.5105.80.1.2.2.1.3 .1.3.6.1.4.1.5105.80.1.2.2.1.4 .1.3.6.1.4.1.5105.80.1.2.2.1.5 .1.3.6.1.4.1.5105.80.1.2.2.1.6"

    
    if isHeartBeat():
            a = "1"
            
    elif (get_fileTransType_vlue() == "15"):
    ...
    elif (get_fileTransType_vlue() == "13"):
    ...
    elif (get_fileTransType_vlue() == "16"):
        ...
        softwarePackVersionoid=scriptinterface.getSnmpOidForNodeName('softwarePackVersion')
    ...
    elif (get_fileTransType_vlue() == "12"):
    ...
    elif (without.find(scriptinterface.getCurrentOID()) == -1):
            #print scriptinterface.getCurrentOID(),"a"
            #print scriptinterface.getCurrentInstance(),"b"
            #print scriptinterface.getCurrentOIDWithInstance(),"c"
            #print scriptinterface.getCurrentValue(),"d"
